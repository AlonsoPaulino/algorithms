...
int main() {
    ...
    /* k is the number of differents numbers from 1 .. K from strings */
    /* n is the number of strings with MAX_LENGTH = K */
    /* is required read n lines with strings of length k */
